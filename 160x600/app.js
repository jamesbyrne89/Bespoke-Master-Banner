...
function adVisibilityHandler() {
	...
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600 = [{}];
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0]._id = 0;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].ID = 1;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Active = true;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Default = false;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Click_Tag = "https:\/\/www.sky.com\/kids";
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Reporting_Label = "OSM_CUST_UP-Q4_KIDS_NA_Bespoke_302980";
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Start_Date = {};
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Start_Date.RawValue = "2017/06/02 8:30";
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Start_Date.UtcValue = 1496392200000;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].End_Date = {};
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].End_Date.RawValue = "2017/06/30 23:59";
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].End_Date.UtcValue = 1498867140000;
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets = {
		"tablet.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054126873_tablet.png"
		},
		"sky_kids_logo.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054118781_sky_kids_logo.png"
		},
		"sky_kids_logo_lg.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054110603_sky_kids_logo_lg.png"
		},
		"morph.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054101324_morph.png"
		},
		"frame_two_text.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054053832_frame_two_text.png"
		},
		"frame_three_text.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054046315_frame_three_text.png"
		},
		"frame_three_relational_text.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054038257_frame_three_relational_text.png"
		},
		"frame_one_text.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054031564_frame_one_text.png"
		},
		"CTA.png": {
			"Type": "file",
		...
		"character_top.png": {
			"Type": "file",
			"Url": "https://s0.2mdn.net/ads/richmedia/studio/36187302/36187302_20170523054013369_character_top.png"
		}
	};
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Legal_Button = "Click for legals";
	devDynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Legal_Copy = "UK\/Ireland only. Sky TV subscription, Variety or Box Sets Bundle & compatible tablet required. Selected content available using 3G\/4G\/WiFi. Available on two registered compatible devices. Further terms apply.";
...
function preloadImages() {
	...
	queue.loadFile({
		id: "skyKidsLogo",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['sky_kids_logo.png'].Url
	});
	queue.loadFile({
		id: "morph",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['morph.png'].Url
	});
	queue.loadFile({
		id: "tablet",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['tablet.png'].Url
	});
	queue.loadFile({
		id: "characterTop",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['character_top.png'].Url
	});
	queue.loadFile({
		id: "cta",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['CTA.png'].Url
	});
	queue.loadFile({
		id: "frameOneText",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['frame_one_text.png'].Url
	});
	queue.loadFile({
		id: "frameTwoText",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['frame_two_text.png'].Url
	});
	queue.loadFile({
		id: "frameThreeText",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['frame_three_text.png'].Url
	});
	queue.loadFile({
		id: "frameThreeRelText",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['frame_three_relational_text.png'].Url
	});
	queue.loadFile({
		id: "skyKidsLogoLg",
		src: dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Assets['sky_kids_logo_lg.png'].Url
	});
};
...
function frame1(assets, canvas, loopCounter, numberOfLoops) {
	...
	createjs.Tween.get(cta).wait(2000).to({
			scaleX: 0.7,
			scaleY: 0.7
...
function createGlint(target) {
	...
	// The glint effect
	glint.graphics.beginLinearGradientFill(["rgba(255,255,255,0.2)", "rgba(255,255,255,1)", "rgba(255,255,255,0)"], [0, 0.2, 0.9], -140, 0, 15, 30).drawRect(-5, 0, 20, target.image.height);
	glint.rotation = 20;
	...
	TweenLite.to(glint, 1, {
		x: maskArea.getBounds().width * 1.3,
		delay: 1.5,
...
function createLegals() {
	...
	copy.innerHTML = dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Legal_Copy;

	var label = document.getElementById('legal-button-label');
	TweenLite.to(label, 0.5, {
		opacity: 1
	})
	label.innerHTML = dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Legal_Button;

	var legalButton = document.getElementById('legal-button');

	legalButton.addEventListener('click', function(e) {
		document.getElementById('legal-copy-container').style.top = '400px';
	}, false);
};
...
function exitButtonHandler() {
	Enabler.exitOverride('Exit', dynamicContent.OSM_CUST_UPQ4_KIDS_NA_Bespoke_302980_160x600[0].Click_Tag);
};